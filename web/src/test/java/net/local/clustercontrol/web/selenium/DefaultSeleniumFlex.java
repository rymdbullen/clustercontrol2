...
public class DefaultSeleniumFlex extends DefaultSelenium {
	...
	public DefaultSeleniumFlex(String serverHost, int serverPort, String browserStartCommand, String browserURL) {
	...
	public String getFlexSelectedItemAtIndex(String target, String args)
			throws Exception {
		return executeCommand("getFlexSelectedItemAtIndex", target, args)
				.replace("OK,", "");
	}

	public String getFlexSelectedItemAtIndex(String target) throws Exception {
		return executeCommand("getFlexSelectedItemAtIndex", target, "")
				.replace("OK,", "");
	}

	public String getFlexNumSelectedItems(String target, String args)
			throws Exception {
		return executeCommand("getFlexNumSelectedItems", target, args).replace(
				"OK,", "");
	}

	public String getFlexNumSelectedItems(String target) throws Exception {
		return executeCommand("getFlexNumSelectedItems", target, "").replace(
				"OK,", "");
	}
	...
	public String getFlexSelectionIndex(String target) throws Exception {
		return executeCommand("getFlexSelectionIndex", target, "").replace(
				"OK,", "");
	}
	...
	public String getFlexGlobalPosition(String target) throws Exception {
		return executeCommand("getFlexGlobalPosition", target, "").replace(
				"OK,", "");
	}
	...
	public String getFlexDataGridRowCount(String target, String args)
			throws Exception {
		return executeCommand("getFlexDataGridRowCount", target, args).replace(
				"OK,", "");
	}

	public String getFlexDataGridRowCount(String target) throws Exception {
		return executeCommand("getFlexDataGridRowCount", target, "").replace(
				"OK,", "");
	}

	public String getFlexDataGridFieldValueForGridRow(String target, String args)
			throws Exception {
	...
	public String getFlexDataGridCell(String target, String args)
			throws Exception {
		return executeCommand("getFlexDataGridCell", target, args).replace(
				"OK,", "");
	}
	...
	public String getFlexComponentInfo(String target) throws Exception {
		return executeCommand("getFlexComponentInfo", target, "").replace(
				"OK,", "");
	}

	public String getFlexComboContainsLabel(String target, String args)
			throws Exception {
		return executeCommand("getFlexComboContainsLabel", target, args)
				.replace("OK,", "");
	}

	public String getFlexComboContainsLabel(String target) throws Exception {
		return executeCommand("getFlexComboContainsLabel", target, "").replace(
				"OK,", "");
	}
	...
	public String getFlexCheckBoxChecked(String target) throws Exception {
		return executeCommand("getFlexCheckBoxChecked", target, "").replace(
				"OK,", "");
	}
	...
	public String getFlexAlertTextPresent(String target) throws Exception {
		return executeCommand("getFlexAlertTextPresent", target, "").replace(
				"OK,", "");
	}
	...
	public String getFlexDataGridCellText(String target) throws Exception {
		return executeCommand("getFlexDataGridCellText", target, "").replace(
				"OK,", "");
	}
	...
	public void flexSetDataGridCell(String target, String args)
			throws Exception {
	...
	public void flexSelectMatchingOnField(String target, String args)
			throws Exception {
	...
	public void flexSelectComboByLabel(String target, String args)
			throws Exception {
	...
	public void flexAddSelectMatchingOnField(String target, String args)
			throws Exception {
	...
	public String rawFlexClickMenuBarUIComponent(String target, String args)
			throws Exception {
		return executeCommand("rawFlexClickMenuBarUIComponent", target, args)
				.replace("OK,", "");
	}

	public String rawFlexClickMenuBarUIComponent(String target)
			throws Exception {
		return executeCommand("rawFlexClickMenuBarUIComponent", target, "")
				.replace("OK,", "");
	}

	public String rawFlexClickDataGridItem(String target, String args)
			throws Exception {
		return executeCommand("rawFlexClickDataGridItem", target, args)
				.replace("OK,", "");
	}

	public String rawFlexClickDataGridItem(String target) throws Exception {
		return executeCommand("rawFlexClickDataGridItem", target, "").replace(
				"OK,", "");
	}

	public String rawFlexSetDataGridCell(String target, String args)
			throws Exception {
		return executeCommand("rawFlexSetDataGridCell", target, args).replace(
				"OK,", "");
	}

	public String rawFlexSetDataGridCell(String target) throws Exception {
		return executeCommand("rawFlexSetDataGridCell", target, "").replace(
				"OK,", "");
	}

	public String rawFlexSelectMatchingOnField(String target, String args)
			throws Exception {
		return executeCommand("rawFlexSelectMatchingOnField", target, args)
				.replace("OK,", "");
	}

	public String rawFlexSelectMatchingOnField(String target) throws Exception {
		return executeCommand("rawFlexSelectMatchingOnField", target, "")
				.replace("OK,", "");
	}

	public String rawFlexDataGridCell(String target, String args)
			throws Exception {
		return executeCommand("rawFlexDataGridCell", target, args).replace(
				"OK,", "");
	}
	...
	public String rawFlexDataGridRowIndexForFieldValue(String target,
			String args) throws Exception {
		return executeCommand("rawFlexDataGridRowIndexForFieldValue", target,
				args).replace("OK,", "");
	}
	...
	public String rawFlexDataGridRowIndexForFieldLabel(String target,
			String args) throws Exception {
		return executeCommand("rawFlexDataGridRowIndexForFieldLabel", target,
				args).replace("OK,", "");
	}
	...
	public String rawFlexDataGridFieldValueForGridRow(String target, String args)
			throws Exception {
		return executeCommand("rawFlexDataGridFieldValueForGridRow", target,
				args).replace("OK,", "");
	}

	public String rawFlexDataGridFieldValueForGridRow(String target)
			throws Exception {
		return executeCommand("rawFlexDataGridFieldValueForGridRow", target, "")
				.replace("OK,", "");
	}

	public String rawFlexDataGridFieldLabelForGridRow(String target, String args)
			throws Exception {
		return executeCommand("rawFlexDataGridFieldLabelForGridRow", target,
				args).replace("OK,", "");
	}

	public String rawFlexDataGridFieldLabelForGridRow(String target)
			throws Exception {
		return executeCommand("rawFlexDataGridFieldLabelForGridRow", target, "")
				.replace("OK,", "");
	}
	...
	public String rawFlexDataGridUIComponentLabel(String target, String args)
			throws Exception {
		return executeCommand("rawFlexDataGridUIComponentLabel", target, args)
				.replace("OK,", "");
	}

	public String rawFlexDataGridUIComponentLabel(String target)
			throws Exception {
		return executeCommand("rawFlexDataGridUIComponentLabel", target, "")
				.replace("OK,", "");
	}

	public String rawFlexDataGridCellText(String target, String args)
			throws Exception {
		return executeCommand("rawFlexDataGridCellText", target, args).replace(
				"OK,", "");
	}

	public String rawFlexDataGridCellText(String target) throws Exception {
		return executeCommand("rawFlexDataGridCellText", target, "").replace(
				"OK,", "");
	}

	public String rawFlexProperties(String target, String args)
			throws Exception {
	...
	public String rawFlexGlobalPosition(String target, String args)
			throws Exception {
		return executeCommand("rawFlexGlobalPosition", target, args).replace(
				"OK,", "");
	}

	public String rawFlexGlobalPosition(String target) throws Exception {
		return executeCommand("rawFlexGlobalPosition", target, "").replace(
				"OK,", "");
	}

	public String rawFlexComboContainsLabel(String target, String args)
			throws Exception {
		return executeCommand("rawFlexComboContainsLabel", target, args)
				.replace("OK,", "");
	}

	public String rawFlexComboContainsLabel(String target) throws Exception {
		return executeCommand("rawFlexComboContainsLabel", target, "").replace(
				"OK,", "");
	}
}
